...
--Setting default path for neovim
...
vim.api.nvim_set_hl(0, 'SignColumn', { bg = 'none' })-- [[ Setting options ]]
...
--Ctrl S for exiting and saving 
vim.keymap.set('i', '<C-s>', '<Esc>:w<CR>', { desc = 'Exit insert and save' })
vim.keymap.set('n', '<C-s>', ':w<CR>', { desc = 'Save file' })

--leader e for neotree
...
--zz to exit 
vim.keymap.set('n', 'zz', ':bd!<CR>', { desc = 'Close buffer' })
...
vim.keymap.set('n', '<F5>', function()
  ...
  elseif ft == 'typescript' then
    vim.cmd('term npx ts-node "' .. file .. '"')
  elseif ft == 'c' then
    vim.cmd('term gcc "' .. file .. '" -o out && out')

  elseif ft == 'cpp' then
    local filename = vim.fn.expand('%:t:r')
    local dir = vim.fn.expand('%:p:h')
      vim.cmd('term g++ "' .. file .. '" -o "' .. dir .. '/' .. filename .. '" && "' .. dir .. '/' .. filename .. '"')
